...
dyGiLa_file_path_n45 = "./Wiman2016-dyGiLa-A11-z--4.5xi0-x--11.01xi0-11.01xi0-t5000.csv"
dyGiLa_file_path_n25 = "./Wiman2016-dyGiLa-A11-z--2.5xi0-x--11.01xi0-11.01xi0-t5000.csv"
dyGiLa_file_path_n05 = "./Wiman2016-dyGiLa-A11-z--0.5xi0-x--11.01xi0-11.01xi0-t5000.csv"
...
ax.plot(x_arr_dyGiLa_n45, ReA11Array_n45,
        linewidth=LineWidth, 
        label=fr'$ReA_{{xx}}\,,dyGiLa\,\gamma = {gamma}\,, 5000t_{{GL}}\,,z=-4.5\xi_{{0}}$',
        linestyle=line_styles[0], color=lineColors[1])    

ax.plot(x_arr_dyGiLa_n25, ReA11Array_n25,
        linewidth=LineWidth, 
        label=fr'$ReA_{{xx}}\,,dyGiLa\,\gamma = {gamma}\,, 5000t_{{GL}}\,,z=-2.5\xi_{{0}}$',
        linestyle=line_styles[1], color=lineColors[1])    

ax.plot(x_arr_dyGiLa_n05, ReA11Array_n05,
        linewidth=LineWidth, 
        label=fr'$ReA_{{xx}}\,,dyGiLa\,\gamma = {gamma}\,, 5000t_{{GL}}\,,z=-0.5\xi_{{0}}$',
...
dyGiLa_file_path_n45 = "./Wiman2016-VerHem15MDoF-ReAxx-ZTScalingOnly-z--4.5xi0-x--11.77-to-11.77xi0-3e-13L2.csv"
dyGiLa_file_path_n25 = "./Wiman2016-VerHem15MDoF-ReAxx-ZTScalingOnly-z--2.5xi0-x--11.77-to-11.77xi0-3e-13L2.csv"
dyGiLa_file_path_n05 = "./Wiman2016-VerHem15MDoF-ReAxx-ZTScalingOnly-z--0.5xi0-x--11.77-to-11.77xi0-3e-13L2.csv"
...
ax.plot(x_arr_verhem_n45, ReA11Array_n45,
        linewidth=LineWidth, 
        label=fr'$ReA_{{xx}}\,,VerHem\,|Residul|_{{L_{{2}}}} = 3.3e-13\,, z=-4.5\xi_{{0}}$',
        linestyle=line_styles[0], color=lineColors[2])    

ax.plot(x_arr_verhem_n25, ReA11Array_n25,
        linewidth=LineWidth, 
        label=fr'$ReA_{{xx}}\,,VerHem\,|Residul|_{{L_{{2}}}} = 3.3e-13\,, z=-2.5\xi_{{0}}$',
        linestyle=line_styles[1], color=lineColors[2])    

ax.plot(x_arr_verhem_n05, ReA11Array_n05,
        linewidth=LineWidth, 
        label=fr'$ReA_{{xx}}\,,VerHem\,|Residul|_{{L_{{2}}}} = 3.3e-13\,, z=-0.5\xi_{{0}}$',
...
ax.set_ylabel(r"$ReA_{{xx}}/\frac{{\Delta_B}}{{\sqrt{{3}}}}$", fontsize=26.0)
