...
ax1.plot(measureData_h30mT_tauQ50.values[:,0], measureData_h30mT_tauQ50.values[:,1]/Tcp, linewidth=LineWidth, label=r'$T/T_{c}\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='solid', color=(0, 0, 1.0))
