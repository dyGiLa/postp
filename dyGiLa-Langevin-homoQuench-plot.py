...
measureData_relexingt320 = pd.read_csv('/home/heidi/Documents/dyGiLa-project/dyGiLa-data/dyGiLa-Langevin/thermal-bath-UniT-quench-V-2/stats/measure-stream.csv', sep=' ', header=None)
#print(measureData_relexingt320.values[:,0])
#print(measureData_relexingt320.values[:,1])

measureData_relexingt386 = pd.read_csv('/home/heidi/Documents/dyGiLa-project/dyGiLa-data/dyGiLa-Langevin/thermal-bath-UniT-quench-V-3/stats/measure-stream.csv', sep=' ', header=None)
#print(measureData_relexingt386.values[:,0])
#print(measureData_relexingt386.values[:,1])

measureData_relexingt493 = pd.read_csv('/home/heidi/Documents/dyGiLa-project/dyGiLa-data/dyGiLa-Langevin/thermal-bath-UniT-quench-V-4/stats/measure-stream.csv', sep=' ', header=None)

measureData_relexingt639 = pd.read_csv('/home/heidi/Documents/dyGiLa-project/dyGiLa-data/dyGiLa-Langevin/thermal-bath-UniT-quench-V-5/stats/measure-stream.csv', sep=' ', header=None)

measureData_relexingt1000 = pd.read_csv('/home/heidi/Documents/dyGiLa-project/dyGiLa-data/dyGiLa-Langevin/thermal-bath-UniT-quench-V/stats/measure-stream.csv', sep=' ', header=None)
...
ax1.plot(measureData_relexingt320.values[:,0], measureData_relexingt320.values[:,1]/Tcp, label=r'$T/T_{c}\,,t_{Q1relx}=320t_{GL}$', linestyle='solid', color=(0, 0, 1.0))
ax1.plot(measureData_relexingt386.values[:,0], measureData_relexingt386.values[:,1]/Tcp, label=r'$T/T_{c}\,,t_{Q1relx}=386t_{GL}$', linestyle='solid', color=(0.2, 0, 0.8))
ax1.plot(measureData_relexingt493.values[:,0], measureData_relexingt493.values[:,1]/Tcp, label=r'$T/T_{c}\,,t_{Q1relx}=493t_{GL}$', linestyle='solid', color=(0.4, 0, 0.6))
ax1.plot(measureData_relexingt639.values[:,0], measureData_relexingt639.values[:,1]/Tcp, label=r'$T/T_{c}\,,t_{Q1relx}=639t_{GL}$', linestyle='solid', color=(0.6, 0, 0.4))
ax1.plot(measureData_relexingt1000.values[:,0], measureData_relexingt1000.values[:,1]/Tcp, label=r'$T/T_{c}\,,t_{Q1relx}=1000t_{GL}$', linestyle='solid', color=(0.8, 0, 0.2))


ax2 = ax1.twinx() 
ax2.plot(measureData_relexingt320.values[:,0], measureData_relexingt320.values[:,4], label=r'$|\Delta|\,,t_{Q1relx}=320t_{GL}$', linestyle='dashdot', color=(0, 0, 1.0))
ax2.plot(measureData_relexingt386.values[:,0], measureData_relexingt386.values[:,4], label=r'$|\Delta|\,,t_{Q1relx}=386t_{GL}$', linestyle='dashdot', color=(0.2, 0, 0.8))
ax2.plot(measureData_relexingt493.values[:,0], measureData_relexingt493.values[:,4], label=r'$|\Delta|\,,t_{Q1relx}=493t_{GL}$', linestyle='dashdot', color=(0.4, 0, 0.6))
ax2.plot(measureData_relexingt639.values[:,0], measureData_relexingt639.values[:,4], label=r'$|\Delta|\,,t_{Q1relx}=639t_{GL}$', linestyle='dashdot', color=(0.6, 0, 0.4))
ax2.plot(measureData_relexingt1000.values[:,0], measureData_relexingt1000.values[:,4], label=r'$|\Delta|\,,t_{Q1relx}=1000t_{GL}$', linestyle='dashdot', color=(0.8, 0, 0.2))
...
ax1.grid(True)
ax1.legend(prop={'size': 18}, bbox_to_anchor=(1.25, 1.0), loc='upper right')
ax2.legend(prop={'size': 18}, bbox_to_anchor=(1.25, 0.0), loc='lower right')
