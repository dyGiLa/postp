...
base_dir = '/home/heidi/ReHD/dyGiLa-project/dyGiLa-data/dyGiLa-Langevin/thermal-bath-UniT-Hfield-quenches/lumi-runs/thermal-bath-UniT-Hfield-quenches/LUMI-G/project_462000960/cube-1024/H-00mT/p-23bar/RSeed-1728-tauQ-50-5050tGL'
...
# # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> #
    ...
    ax2.plot(df["t"], d2Vrp5d2t, linewidth=LineWidth, label=fr'$\frac{{d^{{2}}p_B}}{{d^{{2}}t}}\,,\tau_Q={ptauQ}t_{{GL}}$', linestyle=line_styles[0], color=lineColors[0])
