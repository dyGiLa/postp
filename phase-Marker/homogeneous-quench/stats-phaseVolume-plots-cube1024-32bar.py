...
# # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> #
    ...
    ax2.plot(df["t"], df["Vratio_p5_acc"], linewidth=LineWidth, label=fr'$p_B\,,\tau_Q={ptauQ}t_{{GL}}$', linestyle=line_styles[0], color=lineColors[0])

    ax2.plot(df["t"], df["Vratio_p9_acc"], linewidth=LineWidth, label=fr'$p_A\,,\tau_Q={ptauQ}t_{{GL}}$', linestyle=line_styles[0], color=lineColors[1])

    ax2.plot(df["t"], df["Vratio_p3_acc"], linewidth=LineWidth, label=fr'$p_{{planar}}\,,\tau_Q={ptauQ}t_{{GL}}$', linestyle=line_styles[1], color=lineColors[2])

    ax2.plot(df["t"], df["Vratio_p7_acc"], linewidth=LineWidth, label=fr'$p_P\,,\tau_Q={ptauQ}t_{{GL}}$', linestyle=line_styles[2], color=lineColors[3])

    ax2.plot(df["t"], df["Vratio_p8_acc"], linewidth=LineWidth, label=fr'$p_{{bi}}\,,\tau_Q={ptauQ}t_{{GL}}$', linestyle=line_styles[4], color=lineColors[4])

    ax2.plot(df["t"], df["Vratio_p1_acc"], linewidth=LineWidth, label=fr'$p_{{bg}}\,,\tau_Q={ptauQ}t_{{GL}}$', linestyle=line_styles[5], color=lineColors[6])
