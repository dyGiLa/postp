...
# # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> #
    ...
    ax2.plot(df["t"], dVrp5dt, linewidth=LineWidth, label=fr'$\frac{{dp_B}}{{dt}}\,,\tau_Q={ptauQ}t_{{GL}}$', linestyle=line_styles[0], color=lineColors[0])

    ax2.plot(df["t"], dVrp9dt, linewidth=LineWidth, label=fr'$\frac{{dp_A}}{{dt}}\,,\tau_Q={ptauQ}t_{{GL}}$', linestyle=line_styles[0], color=lineColors[1])

    ax2.plot(df["t"], dVrp3dt, linewidth=LineWidth, label=fr'$\frac{{dp_{{plnanr}}}}{{dt}}\,,\tau_Q={ptauQ}t_{{GL}}$', linestyle=line_styles[1], color=lineColors[2])

    ax2.plot(df["t"], dVrp1dt, linewidth=LineWidth, label=fr'$\frac{{dp_{{bg}}}}{{dt}}\,,\tau_Q={ptauQ}t_{{GL}}$', linestyle=line_styles[0], color=lineColors[6])    
