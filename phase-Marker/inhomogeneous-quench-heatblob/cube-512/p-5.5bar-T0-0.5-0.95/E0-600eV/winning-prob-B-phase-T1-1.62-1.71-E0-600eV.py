...
root_dir = '/home/heidi/ReHD/dyGiLa-project/dyGiLa-data/lumi-project_462000960/project_462000960/heterogenouos-quench/cube-512/H-30mT/p-5.5bar-T0-0.5-0.95/E0-600eV'

# Base glob pattern to match all pv.csv files under RSeed-* folders
pattern = os.path.join(root_dir, "RSeed-*-T0-0.80-0.89", "p-5.5-T1-*", "stats", "phaseVolume-stream.csv")
...
T0Array=np.array([0.8, 0.81, 0.82, 0.83, 0.84, 0.85, 0.86, 0.87, 0.88, 0.89])

ax.plot(T0Array, probabilities, linestyle='--', color='red')
ax.scatter(T0Array, probabilities, marker='o', s=s[2], color='blue', label=fr'B-phase winning prob, 5.5 bar 30mT, $E_{{0}}=600eV$ ')
...
plot_name = 'B-phase-winning-probability-p5.5-H30mT-Ei600eV-T0-0.80-0.89.png'
