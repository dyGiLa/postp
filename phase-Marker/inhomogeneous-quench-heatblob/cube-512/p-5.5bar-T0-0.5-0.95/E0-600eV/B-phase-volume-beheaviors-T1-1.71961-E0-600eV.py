...
pattern = os.path.join(root_dir, "RSeed-*-T0-0.80-0.89", "p-5.5-T1-1.71961", "stats", "phaseVolume-stream.csv")
...
plot_name = 'B-phase-Bubble-Beheavior-E0-600eV-blobR-3.07um-AllSamples.png'
