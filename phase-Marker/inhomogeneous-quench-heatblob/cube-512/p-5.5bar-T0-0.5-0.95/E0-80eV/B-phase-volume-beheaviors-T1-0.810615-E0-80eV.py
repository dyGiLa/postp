...
pattern = os.path.join(root_dir, "RSeed-*-T0-0.5-0.95", "p-5.5-T1-0.810615", "stats", "phaseVolume-stream.csv")
...
thinwall_Rc = 742.6597582037996 # nm
...
ax.axhline(y=7031.29, label='critic volume', color='red', linestyle='-.', linewidth=4)  
...
plot_name = 'B-phase-Bubble-Beheavior-E0-80eV-blobR-1.124um-AllSamples.png'
