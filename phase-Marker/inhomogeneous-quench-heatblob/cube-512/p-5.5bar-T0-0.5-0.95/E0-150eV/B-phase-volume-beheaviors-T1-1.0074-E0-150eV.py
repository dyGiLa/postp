...
pattern = os.path.join(root_dir, "RSeed-*-T0-0.5-0.95", "p-5.5-T1-1.0074", "stats", "phaseVolume-stream.csv")
...
thinwall_Rc = 885.4166666666666 # nm
...
ax.axhline(y=20572.5, label='critic volume', color='red', linestyle='-.', linewidth=4)  
...
plot_name = 'B-phase-Bubble-Beheavior-E0-150eV-blobR-1.57um-AllSamples.png'
