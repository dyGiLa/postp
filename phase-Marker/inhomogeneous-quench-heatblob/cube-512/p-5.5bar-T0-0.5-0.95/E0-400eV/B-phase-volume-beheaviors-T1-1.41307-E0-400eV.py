...
pattern = os.path.join(root_dir, "RSeed-*-T0-0.7-0.95", "p-5.5-T1-1.41307", "stats", "phaseVolume-stream.csv")
...
thinwall_Rc = 1234.887737478411 # nm
...
ax.axhline(y=166214, label='critic volume', color='red', linestyle='-.', linewidth=4)  
...
plot_name = 'B-phase-Bubble-Beheavior-E0-400eV-blobR-2.48um-AllSamples.png'
