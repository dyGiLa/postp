...
root_dir = '/home/heidi/ReHD3/dyGiLa-project/project_462000960/heterogenouos-quench/cube-1024/H-30mT/p-5.5bar-T0-0.80-0.96/E0-1000eV'
...
for T1 in T1_values:
    ...
    prob = (BSucEventsCount_T1 / total) if total > 0 else 0
...
ax.scatter(T0Array, probabilities,
           ...
           label=fr'$p_{{iHB}}$, $5.5$ bar $30mT$, $E_{{0}}=1000eV$ ')
...
plot_name = 'B-phase-Seeding-probability-p5.5-H30mT-E0-1000eV-T0-0.80-0.96.png'
