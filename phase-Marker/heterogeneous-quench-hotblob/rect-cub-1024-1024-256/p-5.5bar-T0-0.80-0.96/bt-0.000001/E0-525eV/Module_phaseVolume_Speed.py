...
def pvSpeedDicts(root_dir: str):
    ...
    print("print from pvSpeedDicts module; pattern", pattern)

    csv_files = glob.glob(pattern)
    print("print from pvSpeedDicts module; csv_files = ", csv_files)
...
############################################################
    ...
    for csv_file in csv_files:
        ...
        print("\n")
        print("print from pvSpeedDicts module; dVrp5dt[-1] : ", dVrp5dt[-1])
        print("print from pvSpeedDicts module; dVrp9dt[-1] : ", dVrp9dt[-1])
        print("print from pvSpeedDicts module; dVrp3dt[-1] : ", dVrp3dt[-1])
        ...
        try:
            ...
            print("print from pvSpeedDicts module; parent_dir = ",parent_dir)
            T1Val_str = parent_dir.replace("p-5.5-T1-", "")
            print("print from pvSpeedDicts module; T1Val_str = ", T1Val_str)        
