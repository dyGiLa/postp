...
root_dir = '/home/heidi/ReHD3/dyGiLa-project/project_462000960/heterogenouos-quench/rect-cub-1024-1024-256/p-5.5bar-T0-0.80-0.96/bt-0.000001/E0-1500eV'
...
ax.scatter(T0Array, probabilities,
           ...
           label=fr'$p_{{tHB}}$, $5.5$ bar $30mT$, $E_{{0}}=1500eV$ ')
