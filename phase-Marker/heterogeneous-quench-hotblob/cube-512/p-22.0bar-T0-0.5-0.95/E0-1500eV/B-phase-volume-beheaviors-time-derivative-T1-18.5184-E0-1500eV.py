...
root_dir = '/home/heidi/ReHD3/dyGiLa-project/project_462000960/heterogenouos-quench/cube-512/H-30mT/p-22bar-T0-0.50-0.95/E0-1500eV'

# Pattern to find all pv.csv files
pattern = os.path.join(root_dir, "RSeed-*-T0-0.50-0.95", "p-22.0-T1-18.5184", "stats", "phaseVolume-stream.csv")
...
plot_name = 'B-phase-Bubble-Beheavior-time-derivative-E0-1500eV-T1-18.5184-AllSamples.png'
