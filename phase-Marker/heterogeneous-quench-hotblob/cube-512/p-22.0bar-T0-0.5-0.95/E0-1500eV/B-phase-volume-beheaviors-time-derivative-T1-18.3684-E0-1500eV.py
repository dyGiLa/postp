...
pattern = os.path.join(root_dir, "RSeed-*-T0-0.50-0.95", "p-22.0-T1-18.3684", "stats", "phaseVolume-stream.csv")
...
plot_name = 'B-phase-Bubble-Beheavior-time-derivative-E0-1500eV-T1-18.3684-AllSamples.png'
