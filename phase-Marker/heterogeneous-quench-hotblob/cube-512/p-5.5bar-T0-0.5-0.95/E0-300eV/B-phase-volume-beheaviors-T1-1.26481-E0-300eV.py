...
root_dir = '/home/heidi/ReHD/dyGiLa-project/dyGiLa-data/lumi-project_462000960/project_462000960/heterogenouos-quench/cube-512/H-30mT/p-5.5bar-T0-0.5-0.95/E0-300eV'

# Pattern to find all pv.csv files
pattern = os.path.join(root_dir, "RSeed-*-T0-0.5-0.95", "p-5.5-T1-1.26481", "stats", "phaseVolume-stream.csv")
...
thinwall_Rc = 1059.0277777777778 # nm
...
ax.axhline(y=74809.7, label='critic volume', color='red', linestyle='-.', linewidth=4)  
...
plot_name = 'B-phase-Bubble-Beheavior-E0-300eV-blobR-2.2um-AllSamples.png'
