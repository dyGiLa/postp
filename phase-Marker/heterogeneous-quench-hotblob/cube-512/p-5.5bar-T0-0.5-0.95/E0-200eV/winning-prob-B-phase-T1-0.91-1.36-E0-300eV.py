...
ax.scatter(T0Array, probabilities, marker='o', s=s[2], color='blue', label=fr'B-phase winning prob, 5.5 bar 30mT, $E_{{0}}=300eV$ ')
...
plot_name = 'B-phase-winning-probability-p5.5-H30mT-Ei300eV-T0-0.5-0.95.png'
