...
pattern = os.path.join(root_dir, "RSeed-*-T0-0.5-0.95", "p-5.5-T1-0.888269", "stats", "phaseVolume-stream.csv")
...
thinwall_Rc = 785.8376511226252 # nm
...
ax.axhline(y=12932.4, label='critic volume', color='red', linestyle='-.', linewidth=4)  
...
plot_name = 'B-phase-Bubble-Beheavior-E0-100eV-blobR-1.28um-AllSamples.png'
