...
root_dir = '/home/heidi/ReHD/dyGiLa-project/dyGiLa-data/lumi-project_462000960/project_462000960/heterogenouos-quench/cube-512/H-30mT/p-5.5bar-T0-0.7-0.95/E0-400eV'

# Base glob pattern to match all pv.csv files under RSeed-* folders
pattern = os.path.join(root_dir, "RSeed-*-T0-0.7-0.95", "p-5.5-T1-*", "stats", "phaseVolume-stream.csv")
...
ax.scatter(T0Array, probabilities, marker='o', s=s[2], color='blue', label=fr'B-phase winning prob, 5.5 bar 30mT, $E_{{0}}=400eV$ ')
...
plot_name = 'B-phase-winning-probability-p5.5-H30mT-Ei400-T0-0.7-0.95.png'
