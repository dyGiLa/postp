...
root_dir = '/home/heidi/ReHD/dyGiLa-project/dyGiLa-data/lumi-project_462000960/project_462000960/heterogenouos-quench/cube-512/H-30mT/p-5.5bar-T0-0.5-0.95/E0-400eV'

# Pattern to find all pv.csv files
pattern = os.path.join(root_dir, "RSeed-*-T0-0.7-0.95", "p-5.5-T1-1.42307", "stats", "phaseVolume-stream.csv")
...
thinwall_Rc = 1183.0742659758203 # nm
...
ax.axhline(y=82835.6, label='critic volume', color='red', linestyle='-.', linewidth=4)  
...
plot_name = 'B-phase-Bubble-Beheavior-E0-400eV-blobR-2.54um-AllSamples.png'
