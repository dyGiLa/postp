...
pattern = os.path.join(root_dir, "RSeed-*-T0-0.7-0.95", "p-5.5-T1-1.43307", "stats", "phaseVolume-stream.csv")
...
plot_name = 'B-phase-Bubble-Beheavior-E0-400eV-blobR-2.61um-AllSamples.png'
