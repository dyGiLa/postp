...
index_join_normal_sf = np.where(measureData_h30mT_tauQ1050.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ1050.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ1050.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ1050.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ1050.values[:,0]), linewidth=LineWidth, label=r'$\frac{d<\sqrt{A^{\dagger}A}>}{dt}\,,\tau_{Q}=1050t_{GL}}$', linestyle='solid', color=(0, 0, 1.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ1150.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ1150.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ1150.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ1150.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ1150.values[:,0]), linewidth=LineWidth, label=r'$\frac{d<\sqrt{A^{\dagger}A}>}{dt}\,,\tau_{Q}=1150t_{GL}}$', linestyle='solid', color=(0, 1.0, 0.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ1250.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ1250.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ1250.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ1250.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ1250.values[:,0]), linewidth=LineWidth, label=r'$\frac{d<\sqrt{A^{\dagger}A}>}{dt}\,,\tau_{Q}=1250t_{GL}}$', linestyle='solid', color=(1.0, 0, 0.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ1350.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ1350.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ1350.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ1350.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ1350.values[:,0]), linewidth=LineWidth, label=r'$\frac{d<\sqrt{A^{\dagger}A}>}{dt}\,,\tau_{Q}=1350t_{GL}}$', linestyle='solid', color=(0.5, 0, 1.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ1450.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ1450.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ1450.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ1450.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ1450.values[:,0]), linewidth=LineWidth, label=r'$\frac{d<\sqrt{A^{\dagger}A}>}{dt}\,,\tau_{Q}=1450t_{GL}}$', linestyle='solid', color=(0.7, 0.6, 0.0))
