...
ax1.plot(measureData_h30mT_tauQ550.values[:,0], measureData_h30mT_tauQ550.values[:,1]/Tcp, linewidth=LineWidth, label=r'$T/T_{c}\,,\tau_{Q}=50t_{GL}}$', linestyle='solid', color=(0, 1.0, 0.0))
ax1.plot(measureData_h30mT_tauQ650.values[:,0], measureData_h30mT_tauQ650.values[:,1]/Tcp, linewidth=LineWidth, label=r'$T/T_{c}\,,\tau_{Q}=50t_{GL}}$', linestyle='solid', color=(0, 1.0, 0.0))
ax1.plot(measureData_h30mT_tauQ750.values[:,0], measureData_h30mT_tauQ750.values[:,1]/Tcp, linewidth=LineWidth, label=r'$T/T_{c}\,,\tau_{Q}=50t_{GL}}$', linestyle='solid', color=(0, 1.0, 0.0))
ax1.plot(measureData_h30mT_tauQ850.values[:,0], measureData_h30mT_tauQ850.values[:,1]/Tcp, linewidth=LineWidth, label=r'$T/T_{c}\,,\tau_{Q}=50t_{GL}}$', linestyle='solid', color=(0, 1.0, 0.0))
ax1.plot(measureData_h30mT_tauQ950.values[:,0], measureData_h30mT_tauQ950.values[:,1]/Tcp, linewidth=LineWidth, label=r'$T/T_{c}\,,\tau_{Q}=50t_{GL}}$', linestyle='solid', color=(0, 1.0, 0.0))
...
index_join_normal_sf = np.where(measureData_h30mT_tauQ550.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax2.plot(measureData_h30mT_tauQ550.values[:,0], np.concatenate((measureData_h30mT_tauQ550.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ550.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,\tau_{Q}=550t_{GL}$', linestyle='dashdot', color=(0, 0.0, 1.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ650.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax2.plot(measureData_h30mT_tauQ650.values[:,0], np.concatenate((measureData_h30mT_tauQ650.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ650.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,\tau_{Q}=650t_{GL}$', linestyle='dashdot', color=(0, 1.0, 0.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ750.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax2.plot(measureData_h30mT_tauQ750.values[:,0], np.concatenate((measureData_h30mT_tauQ750.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ750.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,\tau_{Q}=750t_{GL}$', linestyle='dashdot', color=(1.0, 0.0, 0.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ850.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax2.plot(measureData_h30mT_tauQ850.values[:,0], np.concatenate((measureData_h30mT_tauQ850.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ850.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,\tau_{Q}=850t_{GL}$', linestyle='dashdot', color=(0.5, 0.0, 1.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ950.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax2.plot(measureData_h30mT_tauQ950.values[:,0], np.concatenate((measureData_h30mT_tauQ950.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ950.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,\tau_{Q}=950t_{GL}$', linestyle='dashdot', color=(0.7, 0.6, 0.0))
...
index_join_normal_sf = np.where(measureData_h30mT_tauQ550.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ550.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ550.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ550.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ50.values[:,0]), linewidth=LineWidth, label=r'$\frac{d<\sqrt{A^{\dagger}A}>}{dt}\,,\tau_{Q}=550t_{GL}}$', linestyle='solid', color=(0, 0, 1.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ650.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ650.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ650.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ650.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ150.values[:,0]), linewidth=LineWidth, label=r'$\frac{d<\sqrt{A^{\dagger}A}>}{dt}\,,\tau_{Q}=650t_{GL}}$', linestyle='solid', color=(0, 1.0, 0.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ750.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ750.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ750.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ750.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ750.values[:,0]), linewidth=LineWidth, label=r'$\frac{d<\sqrt{A^{\dagger}A}>}{dt}\,,\tau_{Q}=750t_{GL}}$', linestyle='solid', color=(1.0, 0, 0.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ850.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ850.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ850.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ850.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ850.values[:,0]), linewidth=LineWidth, label=r'$\frac{d<\sqrt{A^{\dagger}A}>}{dt}\,,\tau_{Q}=850t_{GL}}$', linestyle='solid', color=(0.5, 0, 1.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ950.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ950.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ950.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ950.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ950.values[:,0]), linewidth=LineWidth, label=r'$\frac{d<\sqrt{A^{\dagger}A}>}{dt}\,,\tau_{Q}=950t_{GL}}$', linestyle='solid', color=(0.7, 0.6, 0.0))
