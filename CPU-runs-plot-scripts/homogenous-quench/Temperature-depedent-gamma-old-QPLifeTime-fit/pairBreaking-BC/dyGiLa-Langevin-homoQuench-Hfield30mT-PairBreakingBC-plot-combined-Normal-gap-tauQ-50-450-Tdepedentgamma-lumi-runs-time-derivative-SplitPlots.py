...
ax2.plot(measureData_h30mT_tauQ50.values[:,0], np.concatenate((measureData_h30mT_tauQ50.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ50.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,\tau_{Q}=50t_{GL}$', linestyle='dashdot', color=(0.0, 0, 1.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ150.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax2.plot(measureData_h30mT_tauQ150.values[:,0], np.concatenate((measureData_h30mT_tauQ150.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ150.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,\tau_{Q}=150t_{GL}$', linestyle='dashdot', color=(0, 1.0, 0.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ250.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax2.plot(measureData_h30mT_tauQ250.values[:,0], np.concatenate((measureData_h30mT_tauQ250.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ250.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,\tau_{Q}=250t_{GL}$', linestyle='dashdot', color=(1.0, 0, 0.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ350.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax2.plot(measureData_h30mT_tauQ350.values[:,0], np.concatenate((measureData_h30mT_tauQ350.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ350.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,\tau_{Q}=350t_{GL}$', linestyle='dashdot', color=(0.5, 0, 1.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ450.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax2.plot(measureData_h30mT_tauQ450.values[:,0], np.concatenate((measureData_h30mT_tauQ450.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ450.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,\tau_{Q}=450t_{GL}$', linestyle='dashdot', color=(0.7, 0.6, 0.0))
...
index_join_normal_sf = np.where(measureData_h30mT_tauQ50.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ50.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ50.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ50.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ50.values[:,0]), linewidth=LineWidth, label=r'$\frac{d<\sqrt{A^{\dagger}A}>}{dt}\,,\tau_{Q}=50t_{GL}}$', linestyle='solid', color=(0, 0, 1.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ150.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ150.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ150.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ150.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ150.values[:,0]), linewidth=LineWidth, label=r'$\frac{d<\sqrt{A^{\dagger}A}>}{dt}\,,\tau_{Q}=150t_{GL}}$', linestyle='solid', color=(0, 1.0, 0.0))
...
index_join_normal_sf = np.where(measureData_h30mT_tauQ350.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ350.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ350.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ350.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ150.values[:,0]), linewidth=LineWidth, label=r'$\frac{d<\sqrt{A^{\dagger}A}>}{dt}\,,\tau_{Q}=350t_{GL}}$', linestyle='solid', color=(0.5, 0, 1.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ450.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ450.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ450.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ450.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ150.values[:,0]), linewidth=LineWidth, label=r'$\frac{d<\sqrt{A^{\dagger}A}>}{dt}\,,\tau_{Q}=450t_{GL}}$', linestyle='solid', color=(0.7, 0.6, 0.0))
