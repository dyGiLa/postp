...
index_join_normal_sf = np.where(measureData_h30mT_tauQ50.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax2.plot(measureData_h30mT_tauQ50.values[:,0], np.concatenate((measureData_h30mT_tauQ50.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ50.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(1.0, 0, 0.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ150.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
...
index_join_normal_sf = np.where(measureData_h30mT_tauQ350.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
...
index_join_normal_sf = np.where(measureData_h30mT_tauQ450.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
...
# ax2.plot(measureData_h30mT_tauQ550.values[:,0], np.concatenate((measureData_h30mT_tauQ550.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ550.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(0, 1.0, 0.0))
# ax2.plot(measureData_h30mT_tauQ650.values[:,0], np.concatenate((measureData_h30mT_tauQ650.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ650.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(0, 1.0, 0.0))
# ax2.plot(measureData_h30mT_tauQ750.values[:,0], np.concatenate((measureData_h30mT_tauQ750.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ750.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(0, 1.0, 0.0))
# ax2.plot(measureData_h30mT_tauQ850.values[:,0], np.concatenate((measureData_h30mT_tauQ850.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ850.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(0, 1.0, 0.0))
# ax2.plot(measureData_h30mT_tauQ950.values[:,0], np.concatenate((measureData_h30mT_tauQ950.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ950.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(0, 1.0, 0.0))
...
index_join_normal_sf = np.where(measureData_h30mT_tauQ50.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ50.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ50.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ50.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ50.values[:,0]), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(0, 0, 1.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ150.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ150.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ150.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ150.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ150.values[:,0]), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(0, 1.0, 0.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ250.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ250.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ250.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ250.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ250.values[:,0]), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(1.0, 0, 0.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ350.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ350.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ350.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ350.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ150.values[:,0]), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(0.5, 0, 1.0))

index_join_normal_sf = np.where(measureData_h30mT_tauQ450.values[0:,2] >= zeroTol)[0][0]
print(index_join_normal_sf)
ax3.plot(measureData_h30mT_tauQ450.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ450.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ450.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ150.values[:,0]), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(0.7, 1.0, 0.0))


# ax3.plot(measureData_h30mT_tauQ2050.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ2050.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ2050.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ2050.values[:,0]), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(0, 0, 1.0))

# ax3.plot(measureData_h30mT_tauQ2250.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ2250.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ2250.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ2250.values[:,0]), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(0, 0, 1.0))

# ax3.plot(measureData_h30mT_tauQ2450.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ2450.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ2450.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ2450.values[:,0]), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(0, 0, 1.0))

# ax3.plot(measureData_h30mT_tauQ2650.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ2650.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ2650.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ2650.values[:,0]), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(0, 0, 1.0))

# ax3.plot(measureData_h30mT_tauQ2850.values[:,0], np.gradient(np.concatenate((measureData_h30mT_tauQ2850.values[0:index_join_normal_sf,2], measureData_h30mT_tauQ2850.values[index_join_normal_sf:,4])), measureData_h30mT_tauQ2850.values[:,0]), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(0, 0, 1.0))
