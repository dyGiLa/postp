...
ax1.plot(measureData_relexingt1750.values[:,0], measureData_relexingt1750.values[:,1]/Tcp, linewidth=LineWidth, label=r'$T/T_{c}\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='solid', color=(0, 0, 1.0))
...
ax2.plot(measureData_relexingt1750.values[:,0], np.concatenate((measureData_relexingt1750.values[0:index_join_normal_sf,2], measureData_relexingt1750.values[index_join_normal_sf:,4])), linewidth=LineWidth, label=r'$|\Delta|\,,t_{Q1relx}=1750t_{GL}\,,\tau_{Q2}=50t^{0}_{GL}$', linestyle='dashdot', color=(0, 0, 1.0))
